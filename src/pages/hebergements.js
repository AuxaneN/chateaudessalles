...
const SecondPage = () => (
  <Layout>
    ...
    <div className="XIX" style={{ margin: "40px auto" }}>
      ...
      <p style={{ textAlign: "center", fontSize: "24px", margin: "20px auto" }}>
        Petit déjeuner continental inclus, servi tous les matins dans la salle à
        manger ou sur la terrasse du château de 8h30 à 9h30.
      </p>
      <MailButton />
    </div>
    ...
    <div
      className="XIX"
      style={{ width: "100%", maxWidth: "1000px", margin: "40px auto" }}
    >
      <GiteCarousel />
      <TarifsSemaine prix="1400€" prix2="500€" />
      <p style={{ textAlign: "center", fontSize: "24px", margin: "20px auto" }}>
        Location d’un grand appartement moderne privatif situé au 3ème étage de
        la bastide pour six personnes (trois chambres)
      </p>
    </div>
    <MailButton />
    ...
    >
      <ResponsiveWrapper>
        <h4>Détails</h4>
        <p>
          Piscine, parking gratuit, connexion wifi gratuite, boulodrome, chambre
          climatisée ou semi-climatisée, terrasse sous platanes, patio.)
        </p>
        <p>
          Horaires d’arrivée tous les jours entre 16h00 et 18h00 <br />
          Horaires de départ tous les jours à 11h00{" "}
        </p>
        <p>Visite du parc du château et de la chapelle sur demande.</p>
      </ResponsiveWrapper>
    </div>
  </Layout>
)
