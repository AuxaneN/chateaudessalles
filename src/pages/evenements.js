...
const SecondPage = () => (
  <Layout>
    ...
    <TextAndImageEvent
      options={
        <>
          ...
          <p>
            Grande salle de réception du château <br />+ Bar patio
          </p>
        </>
      }
      tarif1="900"
    ...
    <TextAndImageEvent
      options={
        <>
          ...
          <p>
            Grande salle de réception du château <br />
            + Bar patio
            <br />
            + Extérieurs
            <br />+ Terrasse sous les platanes
          </p>
        </>
      }
      tarif1="550"
    ...
    <EvenementTexteAdditionnel
      texte={
        <p>
          - Le mobilier (tables et chaises) est inclus dans la location <br />-
