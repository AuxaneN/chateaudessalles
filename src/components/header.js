  ...
  return (
    ...
    >
      ...
      <LinksWrapper isOpen={isOpen} isFreshLoad={isFreshLoad}>
        <Link to="/" activeStyle={{ color: colors.text }}>
          Accueil
        </Link>
        <Dropdown>
          <Link
        ...
        <Dropdown>
          <Link to="/evenements" activeStyle={{ color: colors.text }}>
            Événements
          </Link>
          <div className="dropdown_elements">
        ...
        <Link to="/agriculture" activeStyle={{ color: colors.text }}>
          Agriculture
        </Link>
        <Link to="/histoire" activeStyle={{ color: colors.text }}>
          Histoire
        </Link>
        <Link to="/contact" activeStyle={{ color: colors.text }}>
          Contact
        </Link>
      </LinksWrapper>
