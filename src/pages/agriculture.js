...
const SecondPage = () => (
  <Layout>
    <TextAndImageWrapper
      title="POTAGER BIOLOGIQUE DE SAISON"
    ...
    <TextAndImageWrapper
      title="OLIVERAIE"
      texte="Environ 200 arbres en cours de restructuration ont été plantés après le terrible gel de 1956 qui avait ravagé trois quart des oliviers de la région. Chaque année, le propriétaire récolte ses olives, accompagné de son fils et de sa femme. Il obtient ainsi une récolte conséquente pour sa consommation personnelle."
      image={<Agri3 />}
    />
    ...
    VARIÉTÉS ANCIENNES"
      ...
      texte2="Une dizaine de poules occupent le poulailler du domaine. Vous aurez la possibilité de déguster leurs œufs au petit déjeuner de la chambre d’hôtes ou en les achetant le mercredi au magasin du potager sur le domaine en vente directe."
      image={<Agri4 />}
      image2={<Agri5 />}
    />
    ...
    <TextAndImageWrapper
      ...
      texte="Un bassin datant du XVIIe siècle est alimenté par une source qui coule toute l’année. Vous pourrez y apercevoir des truites que la famille pêche régulièrement pour sa consommation personnelle."
      image={<Accueil3 />}
    />
